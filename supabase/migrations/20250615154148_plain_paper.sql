/*
  ...
  1. Updates
    - Improved add_session_message function to handle agent messages properly
    - Updated RLS policies for real-time message access
    - Added indexes for better performance
    - Fixed permissions for real-time subscriptions

  2. Security
    - Ensured proper RLS policies for agent message access
    - Added proper permissions for anon users to access messages
*/
