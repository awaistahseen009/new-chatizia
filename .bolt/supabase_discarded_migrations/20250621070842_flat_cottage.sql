/*
  # Fix public chunk search function for embedded chatbots

  1. Updates
    - Create or replace the public_match_document_chunks function
    - Ensure proper permissions for public access
    - Fix vector similarity search for embedded chatbots

  2. Security
    - Allow public access to chunks for active chatbots only
    - Maintain security while enabling embedded functionality
*/
